...
class CreateBoard extends Component {
    ...
    componentDidMount = () => {
        Axios.get('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/allBoards.json')
            .then(response => {
                this.setState({
        ...
        Axios.get('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/boards.json')
            .then(response => {
                this.setState({
    ...
    createBoardHandler = () => {
        ...
        Axios.put('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/allBoards.json', boards)
            .then(response => {
                Axios.put('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/boards.json', boardsData)
                    .then(response => {
