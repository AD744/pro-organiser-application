...
class Board extends Component {
    ...
    addEditedCardToDBHandler = (values) => {
        ...
        let url = 'https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/boards/'+boardData.id+'.json';
    ...
    addCardToDBHandler = (values) => {
        ...
        let url = 'https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/boards/'+this.state.boardData.id+'/cards.json';
        Axios.put(url, cards)
            .then(response => {
                this.setState({
                    showAddCardModal: false,
    ...
    addColumnToDBHandler = () => {
        ...
        Axios.put('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/boards/'+this.state.boardData.id+'/columns.json', columns)
            .then(response => {
                this.setState({
                    showAddColumnModal: false,
                    boardData: boardData,
    ...
    archiveCardHandler = (archived_card) => {
        ...
        Axios.put('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/archivedCards.json', archivedCards)
            .then(response => {
                this.setState({
                    archivedCards: archivedCards,
                    showModal: false
                ...
                Axios.put('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/boards/'+this.state.boardData.id+'/cards.json', updatedCards)
                    .then(response => {
                        this.setState({
                            boardData: boardData
                        })
    ...
    deleteColumnHandler = (column_id) => {
        ...
        Axios.put('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/boards/'+this.state.boardData.id+'.json', boardData)
            .then(response => {
                this.setState({
                    boardData: boardData
                })
    ...
    deleteBoardHandler = () => {
        Axios.get('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn.json')
            .then(response => {
